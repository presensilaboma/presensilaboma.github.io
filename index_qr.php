...
<head>
	...
	<!-- <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/instascan/2.0.0-rc.4/instascan.min.js"></script>   tidak berfungsi --> 
	<script type="text/javascript" src="js/instascan.min.js"></script>

	<!-- DataTables -->
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/datatables.net-bs4/3.2.2/dataTables.bootstrap4.min.js">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/datatables.net-responsive-bs4/3.0.2/responsive.bootstrap4.min.js">
...
<body style="background:#eee">
	<nav class="navbar" style="background:#2c3e50">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="index.php"> <i class="glyphicon glyphicon-qrcode"></i> I am Here</a>
			</div>
			<ul class="nav navbar-nav">
				<li class="active"><a href="index.php"><span class="glyphicon glyphicon-home"></span> Beranda</a></li>

				<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-cog"></span> Kelola <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<li><a href="add.php"><span class="glyphicon glyphicon-plus-sign"></span> Tambah</a></li>
						<li><a href="attendance.php"><span class="glyphicon glyphicon-calendar"></span> Hadir</a></li>
						<li><a href="edit.php"><span class="glyphicon glyphicon-plus-sign"></span> Anggota</a></li>
					</ul>
				</li>
				...
				<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-cog"></span> Back to LMS Control Panel <span class="caret"></span></a>
					<ul class="dropdown-menu">
						...
						<li><a href="../staff/index.php"><span class="glyphicon glyphicon-plus-sign"></span> Staf</a></li>
					</ul>
	...
	<script>
		function Export() {
			var conf = confirm("Ekspor ke Excel");
			if (conf == true) {
	...
	<script>
		...
		Instascan.Camera.getCameras().then(function(cameras) {
			if (cameras.length > 0) {
				// scanner.start(cameras[0]); // webcam internal (laptop)
				scanner.start(cameras[1]); // webcam eksternal
			} else {
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables-responsive/3.0.2/dataTables.responsive.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/datatables.net-responsive-bs4/3.0.2/responsive.bootstrap4.min.js"></script>
